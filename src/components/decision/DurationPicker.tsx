...
export function DurationPicker({ value, onChange }: Props) {
  return (
    <div className="px-4 pb-2">
      ...
      <div className="-mx-1 flex snap-x snap-mandatory gap-2 overflow-x-auto pb-2 pt-1 scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {OPTIONS.map((opt, i) => {
